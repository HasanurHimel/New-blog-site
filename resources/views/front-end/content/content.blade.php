        ...
        <div class="left_content">
            <div class="single_page">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('/') }}">{{ $blog->category_name }}</a></li>
                </ol>
                <h1>{{ $blog->blog_title }}</h1>
                <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Himel </a> <span> {{ $blog->category_name }} <i class="fa fa-calendar"> </i> {{ $blog->updated_at }} </span> <a href="#"> <i class="fa fa-tags"> </i> </a> </div>
