            ...
            <div class="card-body">
                ...
                <div class="widget widget-report-table">
                    ...
                    <div class="grid-form1">
                        <h3 align="center" id="forms-horizontal">Edit Gk</h3>

                        {!! Form::open(['route'=>'gk-update', 'method'=>'post', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data', 'name'=>'category_selected']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input value="{{ $gk->gk_title }}" name="gk_title" type="text" class="form-control" id="gk_title" placeholder="Gk title">
                                <input value="{{ $gk->id }}" name="gk_id" type="hidden" class="form-control" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea rows="440" cols="80" id="summary-ckeditor" name="gk_long_description" id="gk_long_description" class="form-control" placeholder="Gk long description" >{{ $gk->gk_long_description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="radio-inline"><label><input type="radio" {{ $gk->publication_status ==1 ? 'checked' : '' }} name="publication_status" value="1"> Published</label></div>

                                <div class="radio-inline"><label><input type="radio" {{ $gk->publication_status ==0 ? 'checked' : '' }} name="publication_status" value="0"> Unpublished</label></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="submit" class="btn-block btn btn-success " value="Gk Update "/>                                       </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
...
<script>
    document.forms['category_selected'].elements['gk_category_name'].value= '{{ $gk->gk_category }}';
</script>
