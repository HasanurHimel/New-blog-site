            ...
            <div class="card-body">
                ...
                <div class="widget widget-report-table">
                    ...
                    <div class="grid-form1">
                        <h3 align="center" id="forms-horizontal">Create Category</h3>

                        {!! Form::open(['route'=>'category-save', 'method'=>'post', 'class'=>'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="category_description" class="form-control" placeholder="category description" name="category_description"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="submit" class="btn-block btn btn-success " value="Category save "/>                                       </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
