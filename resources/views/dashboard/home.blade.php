                ...
                <div class="widget widget-report-table">
                    ...
                    <div class="row m-0 md-bg-grey-100 p-l-20 p-r-20">
                        <div class="col-md-6 col-sm-6 col-xs-6 w3layouts-aug">
                            <h1 align="center" style="color: #0ab20a">Public message</h1>
                    ...
                    <div class="widget-body p-15">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $public_contact->name }}</td>
                                <td>{{ $public_contact->email }}</td>
                                <td>{{ $public_contact->message }}</td>
                            </tr>
                                @endforeach
                ...
                <div class="card-body p-b-20">
                    <div class="list-group">
                        <a class="list-group-item media" href="">
                            <div class="pull-left">
                                <img class="lg-item-img" src="{{ asset('/') }}dashboard/images/in1.jpg" alt="">
                            </div>
                        ...
                        <a class="list-group-item media" href="">
                            <div class="pull-left">
                                <img class="lg-item-img" src="{{ asset('/') }}dashboard/images/in2.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <div class="pull-left">
                        ...
                        <a class="list-group-item media" href="">
                            <div class="pull-left">
                                <img class="lg-item-img" src="{{ asset('/') }}dashboard/images/in3.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <div class="pull-left">
                        ...
                        <a class="list-group-item media" href="">
                            <div class="pull-left">
                                <img class="lg-item-img" src="{{ asset('/') }}dashboard/images/in4.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <div class="pull-left">
